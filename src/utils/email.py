    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center" style="padding: 30px 0;">
                <table width="100%" max-width="400" cellpadding="0" cellspacing="0"style="background:#ffffff; padding:30px; border-radius:8px; text-align:center;">
                    <tr>
                        <td>
                            <h2 style="margin:0; color:#333;">
                                 کد تأیید ایمیل چشمه نظر
                            </h2>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:20px 0;">
                            <div style="font-size:28px;letter-spacing:6px;font-weight:bold;color:#000;background:#f0f0f0;padding:15px 25px;display:inline-block;border-radius:6px;">
                                {OTP_CODE}
                            </div>
                        </td>
                    </tr>
